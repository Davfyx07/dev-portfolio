      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-card-dark border border-white/10 rounded-xl p-6 space-y-4">
              ...
              <div className="pt-4 border-t border-white/5">
                <h3 className="text-white font-bold mb-3">¿Qué me motiva?</h3>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-card-dark border border-white/10 rounded-lg p-4 text-center">
              ...
              <div className="bg-card-dark border border-white/10 rounded-lg p-4 text-center">
                ...
                <p className="text-xs text-slate-500 mt-1">Tecnologías</p>
              </div>
            </div>
          </div>
        </div>
